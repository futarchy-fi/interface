    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 h-20 px-8 flex items-center justify-between border-b border-white/5 bg-[#0a0a0a]/80 backdrop-blur-xl">
            ...
            <div className="flex items-center gap-4">
                ...
                {/* Connect Wallet (Mock Wagmi) */}
                <button className="flex items-center gap-3 px-1 py-1 pr-4 rounded-full bg-slate-900 border border-slate-800 hover:border-slate-700 transition-all group">
                    ...
                    <div className="flex flex-col items-start leading-none">
                        <span className="text-xs text-slate-400 font-medium group-hover:text-slate-300">Connect Wallet</span>
                    </div>
                </button>
            </div>
        </header>
