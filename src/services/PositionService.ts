...
export class PositionService {
    ...
    async getMarketBalances(userAddress: string, tokenAddresses: string[]): Promise<PositionModel[]> {
        const raw = await this.repo.fetchTokenBalances(userAddress, tokenAddresses);
