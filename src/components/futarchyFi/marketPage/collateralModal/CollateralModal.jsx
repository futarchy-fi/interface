...
// Add helper function to convert wagmi wallet client to ethers signer (same as ConfirmSwapModal)
...
const CollateralModal = ({
  ...
  error,
  proposalId,
  config, // Accept config as prop
  configLoading = false, // Accept configLoading as prop
}) => {
  // Use wagmi hooks like ConfirmSwapModal
  ...
  useEffect(() => {
    console.log('CollateralModal wallet connection state:', {
      account,
      isConnected,
