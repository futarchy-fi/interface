...
export const DEFAULT_BASE_CURRENCY_TOKEN_ADDRESS = '0xaf204776c7245bF4147c2612BF6e5972Ee483701';
...
// Base Token Configuration (Defaults)
export const DEFAULT_BASE_TOKENS_CONFIG = {
    currency: {
...
export const SPLIT_CONFIG = {
    ...
    tokenAddress: DEFAULT_BASE_CURRENCY_TOKEN_ADDRESS,
    outcomes: ['Yes', 'No'],
