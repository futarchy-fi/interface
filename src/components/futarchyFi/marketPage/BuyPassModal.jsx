...
const ProcessingSteps = ({ currentStep }) => {
  const steps = [
    ...
    { id: 'swapping', label: 'Swapping to Company YES' }
  ];
...
const BuyPassModal = ({
  title = 'Buy YES',
  supportText = 'Buy a YES by adding collateral and swapping to company YES token.',
  handleClose,
  handleBuyPass,
  connectedWalletAddress,
  walletIcon = <MetamaskIcon />,
  alertContainerTitle = 'YES Information',
  alertSupportText = 'This will add collateral and swap to company YES token in one transaction.',
  tokenConfig,
  balances,
  processingStep
}) => {
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-medium text-futarchyGray12">
                ...
                {processingStep === 'swapping' && 'Swapping to Company YES...'}
...
BuyPassModal.propTypes = {
  title: PropTypes.string,
  supportText: PropTypes.string,
  handleClose: PropTypes.func.isRequired,
  handleBuyPass: PropTypes.func.isRequired,
