...
export const EventsCard = ({
  ...
  return (
    <a href={getMarketUrl(eventID)} className="block hover:opacity-90 transition-opacity">
...
export const MobileEventsCard = ({
  ...
  return (
    <a href={getMarketUrl(eventID)} className="block w-full hover:opacity-90 transition-opacity">
