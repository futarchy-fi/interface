...
import { DownVectorIcon } from "../cards/Resources";
  ...
  return (
    <div className="relative" ref={dropdownRef}>
      ...
      >
        ...
        <DownVectorIcon className={`w-5 h-5 text-futarchyGray11 dark:text-futarchyGray112 transition-transform ${isOpen ? 'rotate-180' : ''}`} />
      </button>
