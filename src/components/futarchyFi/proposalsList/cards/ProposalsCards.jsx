...
const ProposalActions = ({ proposalID }) => (
  <div className="flex flex-row gap-1 items-center text-sm font-light select-none justify-between">
    <a href={getMarketUrl(proposalID)} className="bg-futarchyGray2 dark:bg-futarchyDarkGray2 border-2 border-futarchyGray4 dark:border-futarchyGray112/40 rounded-xl w-full py-3 px-[14px] text-center flex flex-row justify-center items-center gap-[6px]">
...
export const ProposalsCard = ({
  ...
  return (
    <a href={getMarketUrl(proposalID)} className="group relative block border-2 border-futarchyGray62 dark:border-futarchyGray11/70 rounded-3xl w-full md:w-[340px] shadow-sm hover:shadow-lg transition-all duration-300 overflow-hidden bg-futarchyGray3 dark:bg-futarchyDarkGray2">
