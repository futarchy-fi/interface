...
export const TOKENS: Token[] = [
    { symbol: 'sDAI', name: 'Savings DAI', type: 'COLLATERAL', iconColor: 'bg-green-600' }, // Updated to sDAI
    { symbol: 'NVDA', name: 'Nvidia', type: 'COMPANY', iconColor: 'bg-slate-600' },
    { symbol: 'YES_sDAI', name: 'YES (Currency)', type: 'OUTCOME', iconColor: 'bg-emerald-500' },
    { symbol: 'NO_sDAI', name: 'NO (Currency)', type: 'OUTCOME', iconColor: 'bg-red-500' },
    { symbol: 'YES_NVDA', name: 'YES (Company)', type: 'OUTCOME', iconColor: 'bg-emerald-700' },
    { symbol: 'NO_NVDA', name: 'NO (Company)', type: 'OUTCOME', iconColor: 'bg-red-700' },
];
...
export const TokenSelector: React.FC<TokenSelectorProps> = ({ isOpen, onClose, onSelect, validTokens }) => {
