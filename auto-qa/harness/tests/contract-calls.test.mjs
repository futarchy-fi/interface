/**
 * contract-calls.test.mjs — Phase 4 slice 2: contract-call surface.
 *
 ...
 *
 * Run via:   node --test auto-qa/harness/tests/contract-calls.test.mjs
 *       or:  npm run auto-qa:harness:contracts
 */
