/**
 * wallet-stub.test.mjs — Phase 4 slice 1: EIP-1193 stub against live anvil.
 *
 ...
 *
 * Run via:   node --test auto-qa/harness/tests/wallet-stub.test.mjs
 *       or:  npm run auto-qa:harness:wallet
 */
