// market-page-fixture — sanity check for the market-page
...
// against the live page; this unit check catches "I forgot to export
...
test('PUBLIC_GNOSIS_RPC_URLS — covers the four RPCs in src/utils/getBestRpc.js + the two extras from src/providers/providers.jsx', () => {
    ...
    // This unit check re-derives the expected union — bumping the
