/**
 * 58-time-evolution-foundation.scenario.mjs — first scenario to exercise
 ...
 *
 * ── Why a foundation scenario, not a PR catch ───────────────────────
 ...
 *      catching the regression. (The slice 90 unit test
...
export default {
    name:        '58-time-evolution-foundation',
